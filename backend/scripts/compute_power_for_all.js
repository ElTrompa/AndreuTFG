...
async function main() {
  try {
    ...
    process.env.DB_USER = process.env.DB_USER || 'tfgandreu';
    process.env.DB_PASSWORD = process.env.DB_PASSWORD || 'tfgandreu_pass';
    process.env.DB_NAME = process.env.DB_NAME || 'tfgandreu';
